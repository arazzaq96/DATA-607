...
# Assume df is your already imported data frame
# You can filter or manipulate df directly
library(dplyr)
library(stringr)

# Filter majors that contain either "DATA" or "STATISTICS"
majors_filtered <- Major_list %>%
